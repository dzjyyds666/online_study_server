...
func (c *cosClient) DeleteObject(ctx context.Context, in *DeleteObjectRequest, opts ...grpc.CallOption) (*DeleteObjectResponse, error) {
...
// CosServer is the service API for Cos service.
...
func (UnimplementedCosServer) DeleteObject(context.Context, *DeleteObjectRequest) (*DeleteObjectResponse, error) {
